...
DEFAULT_PATH_PATTERNS = [
    ...
    "sub-{subject}[/ses-{session}]/{datatype<dwi>|dwi}/sub-{subject}[_ses-{session}][_acq-{acquisition}][_dir-{direction}][_space-{space}][_label-{label}][_res-{resolution}][_desc-{desc}][_atlas-{atlas}]_{suffix<dseg>}{extension<.csv|.pickle|.tsv|.json|.nii|.nii.gz>|.nii.gz|}",
