...
setup(
    ...
    url='https://github.com/GalBenZvi/qsiprep_analyses',
    ...
    project_urls={
        ...
        'Changelog': 'https://qsiprep_analyses.readthedocs.io/en/latest/changelog.html',
        'Issue Tracker': 'https://github.com/GalBenZvi/qsiprep_analyses/issues',
    },
    keywords=[
